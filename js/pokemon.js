...
function pokemonsList(film = []){
    var divcontainer = document.createElement('div')
    divcontainer.setAttribute('class','container')
    var ulElement = document.createElement('ul')
    ulElement.setAttribute('class', 'ulelement liststyle-none')
    ...
    for (let i = 0; i < film.length ; i++){
        if(film[i] % 2 === 0){
            liElement.style.border = 'red'
        }
        var liElement = document.createElement('li')
        liElement.setAttribute('class', 'lielement mt-5 mb-3 d-flex flex-column justify-content-center align-items-center')
        ...
        imgtext.setAttribute('class', 'd-block')
        var typetext = document.createElement('p')
        var heighttext = document.createElement('p')
        var weighttext = document.createElement('p')
        var candytext = document.createElement('p')
        var candycounttext = document.createElement('p')
        var eggtext = document.createElement('p')
        var spawnchancetext = document.createElement('p')
        var avgspawnstext = document.createElement('p')
        var spawntimetext = document.createElement('p')
        var multipliersatext = document.createElement('p')
        var weaknessestext = document.createElement('p')
        // var nextevolutiontext = document.createElement('p')

        
        // .setAttribute('id'  ${film[i].id} pokimon )
        // num.textContent = film[i].num
        nametext.textContent = film[i].name
        imgtext.src = film[i].img
        typetext.textContent = film[i].type
        heighttext.textContent = film[i].height
        weighttext.textContent = film[i].weight
        candytext.textContent = film[i].candy
        candycounttext.textContent = film[i].candy_count
        eggtext.textContent = film[i].egg
        spawnchancetext.textContent = film[i].spawn_chance
        avgspawnstext.textContent = film[i].avg_spawns
        spawntimetext.textContent = film[i].spawn_time
        multipliersatext.textContent = film[i].multipliers
        weaknessestext.textContent = film[i].weaknesses
        // nextevolutiontext.textContent = film[i].next_evolution

        // liElement.appendChild(idtext)
        // liElement.appendChild(numtext)
        liElement.appendChild(nametext)
        liElement.appendChild(imgtext)
        liElement.appendChild(typetext)
        liElement.appendChild(heighttext)
        liElement.appendChild(weighttext)
        liElement.appendChild(candytext)
        liElement.appendChild(candycounttext)
        liElement.appendChild(eggtext)
        liElement.appendChild(spawnchancetext)
        liElement.appendChild(avgspawnstext)
        liElement.appendChild(spawntimetext)
        liElement.appendChild(multipliersatext)
        liElement.appendChild(weaknessestext)
        // liElement.appendChild(nextevolutiontext)
